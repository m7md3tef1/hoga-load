...
class Form extends StatefulWidget {
  Form({Key? key,this.isFilter=false,this.productModel,this.isEdit=false,this.index}) : super(key: key);
  bool isFilter;
...
//      stateId = widget.productModel!.state!.id!;
     buyOrSell=widget.productModel!.buyOrSell;
      ...
      ProductsCubit
          .get(context)
          .descController
          .text = widget.productModel!.description == null ? "" :
      widget.productModel!.description!;

      ProductsCubit
          .get(context)
          .img64 = widget.productModel!.productImage!;
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: CustomText(
                                    text: widget.isEdit?"EDIT PRODUCT":widget.isFilter?'SEARCH':'ADD PRODUCT',
                                    fontSize: 18.sp,
...
//                                                            .cityList[index]
                         ...
                         widget.isFilter?const SizedBox(): Padding(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ProductsCubit.get(context).pickFromGallery(
                                      context);
                                },
                                child: Row(
                                  children: [
                                      ...
                                      child: Center(
                                        child: Text(
                                          ...
                                          '${ProductsCubit
                                              ...
                                              .toString()
                                              .split(
                                              '/data/user/0/com.example.hoga_load/cache/image_picker')}'
                                              :
                                          '    No File chosen',
                                          style: TextStyle(
                                              color: const Color(0xFF757575),
                                  ...
                                  ProductsCubit.get(context).editProductCubit(GetProductModel(
                                      id: widget.productModel!.id,
                                          ...
                                          productName: ProductsCubit
                                              ...
                                              .nameController
                                              .text,
                                          priceInt: int.parse(ProductsCubit
                                              .get(context)
                                              .priceController
                                              .text),
